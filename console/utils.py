from preico.settings import WEB3_CONFIG
from web3 import Web3, KeepAliveRPCProvider, IPCProvider
from django.utils.translation import ugettext as _
from os import path
import json
# TODO Move this code to separate library. Is used in second project
...
class ContractHelper():
    base_path = path.join( path.dirname(path.abspath(__file__)), 'build' )
    ABI_FILE_EXT = 'abi'
